...
class BoutiqueDescDesktop extends StatefulWidget {
  const BoutiqueDescDesktop({super.key});

  @override
  State<BoutiqueDescDesktop> createState() => _BoutiqueDescDesktopState();
}

class _BoutiqueDescDesktopState extends State<BoutiqueDescDesktop> {
